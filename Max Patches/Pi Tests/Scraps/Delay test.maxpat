...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "Macintosh HD:/Users/slykiddruthless/Music/Ableton/User Library/REC BY ME/drums/LOOPS/mayo kit 1.wav",
								"filename" : "mayo kit 1.wav",
								"filekind" : "audiofile",
								"id" : "u340004607",
								"loop" : 1,
								"content_state" : 								{
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 245.0, 12.0, 224.0, 78.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 133.0, 136.0, 80.0, 22.0 ],
					"text" : "loadmess 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 201.0, 32.0, 20.0 ],
					"text" : "D/W"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 71.5, 201.0, 25.0, 20.0 ],
					"text" : "FB"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 114.0, 90.0, 20.0 ],
					"text" : "del time ms"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 119.0, 225.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "Macintosh HD:/Users/slykiddruthless/Desktop/CapstoneDrumMachine/Samples/TEST BLIPP.wav",
								"filename" : "TEST BLIPP.wav",
								"filekind" : "audiofile",
								"id" : "u007008727",
								"loop" : 1,
								"content_state" : 								{
...
,
					...
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 15.0, 12.0, 225.0, 78.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 136.0, 90.0, 22.0 ],
					"text" : "loadmess 5000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 39.0, 160.0, 83.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 304.0, 45.0, 45.0 ]
				}
...
,
					"patching_rect" : [ 15.0, 257.0, 85.0, 22.0 ],
					"rnboattrcache" : 					{
...
, 			{
				"name" : "mayo kit 1.wav",
				"bootpath" : "~/Music/Ableton/User Library/REC BY ME/drums/LOOPS",
				"patcherrelativepath" : "../../../../Music/Ableton/User Library/REC BY ME/drums/LOOPS",
				"type" : "WAVE",
				"implicit" : 1
			}
, 			{
